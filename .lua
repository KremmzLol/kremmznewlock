...
Tracer.Data = game:HttpGet("https://us.rule34.xxx//samples/5310/sample_76f98a9c605c0047587bc86cc3071395.jpg?6050975")
Tracer.ZIndex = 99999
...
x("Kremmz Lock", "Loaded", 3)


    if getgenv().flashyes == true then
                       x("Kremmz lock", "Already Loaded", 5)
        return
    end
    ...
    UserInputService.InputBegan:Connect(function(keygo,ok)
           ...
           if (keygo.KeyCode == getgenv().Key) then
               ...
               Plr =  getClosestPlayerToCursor()
                x("Kremmz", ""..Plr.Character.Humanoid.DisplayName, 3)
elseif not Locking then
    if Plr then Plr = nil
                       x("Kremmz lock", "Unlocked", 3)
